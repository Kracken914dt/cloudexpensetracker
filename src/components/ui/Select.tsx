...
const selectVariants = {
  default: 'bg-bg-card border-border-primary focus:ring-accent/50 focus:border-accent',
  outline: 'bg-transparent border-2 border-border-primary focus:ring-accent/30 focus:border-accent',
  filled: 'bg-bg-secondary border-transparent focus:bg-bg-card focus:ring-accent/50'
};
